    ...
    <LegalLayout title="Privacy Policy" updated="June 29, 2026">
      ...
      <Section title="Information we collect">
        <ul className="list-disc pl-5 space-y-1.5">
          <li>
            <strong>Account data</strong> — your email address, display name, and (if you choose)
            avatar URL.
          </li>
          <li>
            <strong>Authentication</strong> — encrypted password and, optionally, a TOTP
            authenticator factor.
          </li>
          <li>
            <strong>Uploaded materials</strong> — the files, titles, subjects and descriptions you
            choose to upload.
          </li>
          <li>
            <strong>Operational logs</strong> — basic security and error logs needed to keep the
            service running.
          </li>
        </ul>
      </Section>
      <Section title="How we use information">
        <p>
          We use your information only to (a) provide the service to you, (b) keep your account
          secure, and (c) comply with the law. We do not sell your data, and we do not use the
          contents of your uploads to train AI models.
        </p>
      </Section>
      ...
      <Section title="Changes">
        <p>
          We will post updates to this page with a new "Last updated" date. Material changes will
          also be communicated by email when feasible.
        </p>
      </Section>
    </LegalLayout>
  );
